...
const VEG: Item[] = [
  ...
  { name: "Potato", price: 35, desc: "Farm fresh potatoes, 1 kg", image: u("1518977676601-b53f82aba655") },
...
const NONVEG: Item[] = [
  ...
  { name: "Tilapia (Jilebi)", price: 280, desc: "Cleaned, 500 g", image: u("1574781330855-d0db8cc6a79c") },
...
const OILS: Item[] = [
  ...
  { name: "Olive Oil", price: 520, desc: "Extra virgin olive oil, 500 ml", image: u("1474979266404-7eaacbcd87c5") },
...
const POWDERS: Item[] = [
  ...
  { name: "Idli Podi", price: 95, desc: "Milagai podi, 200 g", image: u("1599909533734-91eb1d4f5b0b") },
  ...
  { name: "Red Chilli Powder", price: 130, desc: "Guntur chilli powder, 250 g", image: u("1583485088034-697b5bc36b92") },
...
const ORGANIC: Item[] = [
  ...
  { name: "Organic Turmeric Powder", price: 140, desc: "Salem manjal, 200 g", image: u("1615485500704-8e990f9900f7") },
  ...
  { name: "Organic Apple Cider Vinegar", price: 280, desc: "With mother, 500 ml", image: u("1474979266404-7eaacbcd87c5") },
];

const SNACKS: Item[] = [
  { name: "Lays Classic Salted", price: 20, desc: "Lays potato chips, 52 g pack", image: u("1566478989037-eec170784d0b") },
  ...
  { name: "Banana Chips", price: 90, desc: "Kerala banana chips, 250 g", image: u("1599490659213-e2b9527bd087") },
