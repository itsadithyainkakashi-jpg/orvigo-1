...
import tylenolExtraStrength from "@/assets/medicine/tylenol-extra-strength.png";
import antihistamine10mg from "@/assets/medicine/antihistamine-10mg.png";
import tumsAntacid from "@/assets/medicine/tums-antacid.png";
import doubleAntibioticOintment from "@/assets/medicine/double-antibiotic-ointment.png";
import imodiumOriginal from "@/assets/medicine/imodium-original.png";
import dettolAntiseptic from "@/assets/medicine/dettol-antiseptic.png";
import hydrocortisoneCream from "@/assets/medicine/hydrocortisone-cream.png";
import morphineSulfate from "@/assets/medicine/morphine-sulfate.png";
import atorvastatin from "@/assets/medicine/atorvastatin.png";
import lexapro from "@/assets/medicine/lexapro.png";
import domperidone10mg from "@/assets/medicine/domperidone-10mg.png";
import cetzineCetirizine from "@/assets/medicine/cetzine-cetirizine.png";
import ramipril125 from "@/assets/medicine/ramipril-1-25.png";
import mirtazapine15mg from "@/assets/medicine/mirtazapine-15mg.png";
import betamethasoneCream from "@/assets/medicine/betamethasone-cream.png";
import famotidine20mg from "@/assets/medicine/famotidine-20mg.png";
import clonazepam from "@/assets/medicine/clonazepam.png";
import zoloft100mg from "@/assets/medicine/zoloft-100mg.png";
import digoxin from "@/assets/medicine/digoxin.png";
import montelukast10mg from "@/assets/medicine/montelukast-10mg.png";
import gabapentin100mg from "@/assets/medicine/gabapentin-100mg.png";
...
const ITEMS: Item[] = [
  ...
  {
    id: "m-domperidone-10mg-30",
    name: "Domperidone 10mg Tablets",
    price: 189,
    originalPrice: 249,
    desc: "Relieves nausea and vomiting, 30 tablets",
    image: domperidone10mg,
    badge: "Anti-Nausea",
    rxRequired: true,
    rating: 4.5,
  },
  {
    id: "m-cetzine-cetirizine-50",
    name: "Cetirizine Tablets IP (Cetzine)",
    price: 129,
    originalPrice: 179,
    desc: "Allergy & cold relief, 2 x 5 x 10 tablets",
    image: cetzineCetirizine,
    badge: "Allergy Relief",
    rating: 4.7,
  },
  {
    id: "m-ramipril-1-25-100",
    name: "Ramipril Tablets IP 1.25mg",
    price: 239,
    originalPrice: 299,
    desc: "Blood pressure control, 10 x 10 tablets",
    image: ramipril125,
    badge: "BP Control",
    rxRequired: true,
    rating: 4.4,
  ...
  {
    id: "m-mirtazapine-15mg-28",
    name: "Mirtazapine 15mg Film-Coated Tablets",
    price: 349,
    originalPrice: 429,
    desc: "Depression treatment, 28 tablets",
    image: mirtazapine15mg,
    badge: "Mental Health",
    rxRequired: true,
  ...
  {
    id: "m-betamethasone-cream-45",
    name: "Betamethasone Valerate Cream USP 0.1%",
    price: 159,
    originalPrice: 219,
    desc: "Skin irritation & rash relief, 45 g",
    image: betamethasoneCream,
    badge: "Skin Care",
    rxRequired: true,
    rating: 4.6,
  },
  {
    id: "m-famotidine-20mg-28",
    name: "Famotidine 20mg Film-Coated Tablets",
    price: 199,
    originalPrice: 259,
    desc: "Acidity & heartburn relief, 28 tablets",
  ...
  {
    id: "m-clonazepam-100",
    name: "Clonazepam Tablets IP (Clozepam 2)",
    price: 279,
    originalPrice: 349,
    desc: "Anxiety relief, 2 x 5 x 10 tablets",
    image: clonazepam,
    badge: "Anxiety Relief",
    rxRequired: true,
    warning: "Risk of dependence. Strictly as prescribed.",
    rating: 4.4,
  },
  {
    id: "m-zoloft-100mg-28",
    name: "Zoloft 100mg (Sertraline) Tablets",
    price: 399,
    originalPrice: 499,
    desc: "Mental wellness support, 28 tablets",
    image: zoloft100mg,
    badge: "Mental Health",
    rxRequired: true,
    rating: 4.6,
  ...
  {
    id: "m-digoxin-1000",
    name: "Digoxin Tablets USP 0.25mg",
    price: 459,
    originalPrice: 549,
    desc: "Heart care prescription, 1000 tablets",
    image: digoxin,
    badge: "Heart Care",
    rxRequired: true,
    warning: "Narrow therapeutic range. Use as prescribed.",
    rating: 4.2,
  },
  {
    id: "m-montelukast-10mg-30",
    name: "Montelukast 10mg Tablets",
    price: 229,
    originalPrice: 299,
    desc: "Allergy & asthma support, 30 tablets",
    image: montelukast10mg,
    badge: "Asthma Relief",
    rxRequired: true,
    rating: 4.7,
  },
